...
# This script bootstraps the resource-certificates-service into SwarmDB via mysql client.
...
#     /usr/local/lib/sp-swarm-services/apps/resource-certificates-service
...
# Service descriptors
SERVICE_NAME=${SERVICE_NAME:-sp-resource-certificates-service}
SERVICE_VERSION=${SERVICE_VERSION:-1.0.0}
CLUSTER_POLICY=${CLUSTER_POLICY:-sp-resource-certificates-service}
CLUSTER_ID=${CLUSTER_ID:-resource-certificates-service}
