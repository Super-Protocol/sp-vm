...
# This script bootstraps the workload-service into SwarmDB via mysql client.
...
#     /usr/local/lib/sp-swarm-services/apps/workload-service
...
# Service descriptors
SERVICE_NAME=${SERVICE_NAME:-sp-workload-service}
SERVICE_VERSION=${SERVICE_VERSION:-1.0.0}
CLUSTER_POLICY=${CLUSTER_POLICY:-sp-workload-service}
CLUSTER_ID=${CLUSTER_ID:-workload-service}
