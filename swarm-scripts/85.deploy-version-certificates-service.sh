...
# This script bootstraps the version-certificates-service into SwarmDB via mysql client.
...
#     /usr/local/lib/sp-swarm-services/apps/version-certificates-service
...
# Service descriptors
SERVICE_NAME=${SERVICE_NAME:-sp-version-certificates-service}
SERVICE_VERSION=${SERVICE_VERSION:-1.0.0}
CLUSTER_POLICY=${CLUSTER_POLICY:-sp-version-certificates-service}
CLUSTER_ID=${CLUSTER_ID:-version-certificates-service}
