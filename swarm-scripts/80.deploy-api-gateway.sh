...
# This script bootstraps the api-gateway service into SwarmDB via mysql client.
...
#     /usr/local/lib/sp-swarm-services/apps/api-gateway
...
# Service descriptors
SERVICE_NAME=${SERVICE_NAME:-sp-api-gateway}
SERVICE_VERSION=${SERVICE_VERSION:-1.0.0}
CLUSTER_POLICY=${CLUSTER_POLICY:-sp-api-gateway}
CLUSTER_ID=${CLUSTER_ID:-api-gateway}
