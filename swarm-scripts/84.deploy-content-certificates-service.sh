...
# This script bootstraps the content-certificates-service into SwarmDB via mysql client.
...
#     /usr/local/lib/sp-swarm-services/apps/content-certificates-service
...
# Service descriptors
SERVICE_NAME=${SERVICE_NAME:-sp-content-certificates-service}
SERVICE_VERSION=${SERVICE_VERSION:-1.0.0}
CLUSTER_POLICY=${CLUSTER_POLICY:-sp-content-certificates-service}
CLUSTER_ID=${CLUSTER_ID:-content-certificates-service}
