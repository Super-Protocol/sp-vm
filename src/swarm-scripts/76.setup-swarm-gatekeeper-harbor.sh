...
# This script bootstraps the swarm-gatekeeper-harbor service into SwarmDB via swarm-cli.
...
# Service descriptors
SERVICE_NAME=${SERVICE_NAME:-swarm-gatekeeper-harbor}
SERVICE_VERSION=${SERVICE_VERSION:-1.0.0}
CLUSTER_POLICY=${CLUSTER_POLICY:-gatekeeper-harbor}
