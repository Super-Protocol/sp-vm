...
# This script bootstraps the route-manager service into SwarmDB via swarm-cli.
...
# - route-manager dependencies are expected to be expressed in the manifest
...
# Service descriptors
SERVICE_NAME=${SERVICE_NAME:-route-manager}
SERVICE_VERSION=${SERVICE_VERSION:-1.0.0}
CLUSTER_POLICY=${CLUSTER_POLICY:-route-manager}
CLUSTER_ID=${CLUSTER_ID:-route-manager}
