...
def ensure_config_written(
    ...
    """
    Write configuration file for content-certificates-service.
    """
    ...
    # Retry configuration
    lines.append(f"retryInterval: {DEFAULT_RETRY_INTERVAL}")
    lines.append(f"maxRetries: {DEFAULT_MAX_RETRIES}")
    lines.append(f"retryInfoTtl: {DEFAULT_RETRY_INFO_TTL}")
